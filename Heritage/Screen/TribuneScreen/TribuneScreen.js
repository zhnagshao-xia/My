                  ...
                  <View style={styles.one}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row' }}>
                      ...
                      <View >
                        ...
                        <FontAwesome name={'share'} size={23} color={'#000'} />
                        <FontAwesome name={'heart-o'} size={23} color={'#000'} />
                        <FontAwesome name={'comment'} size={23} color={'#000'} />
                        </View>
                      </View>
                    </View>
                  </View>
            ...
            justifyContent: 'center' }}>
              <View style={{ 
                ...
                flexDirection: 'row' }}>
                  ...
                  <Text style={{ fontSize: 17 }}>高血堂</Text>
                ...
                <View style={{width:'85%'}}>
                  <Text style={{ fontSize: 15, }}>官宣：浙江30件国家级非遗位数位列全国第一。</Text>
                </View>
                </View>
                
              </View>
            </View>
            <View style={{ height: '10%', flexDirection: 'row', alignItems: 'center', width: '90%', marginLeft: 20 }}>
              <TouchableOpacity style={{ width: 40, height: 40, marginRight: 10, marginLeft: 5 }}>
